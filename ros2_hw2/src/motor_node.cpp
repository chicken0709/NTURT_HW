...
public:
	MotorNode() : Node("motor_node")
	{
		subscription_ = this->create_subscription<std_msgs::msg::Int32>(
			"pwm_signal", 20, std::bind(&MotorNode::pwmSignalCallback, this, std::placeholders::_1));
		publisher_ = this->create_publisher<std_msgs::msg::Float32>("motor_revs", 20);
	}
private:
	void pwmSignalCallback(const std_msgs::msg::Int32::SharedPtr msg)
	{
		...
		//RCLCPP_INFO(this->get_logger(), "Motor Revs: %f", motor_revs);
	}
